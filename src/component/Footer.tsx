...
const Footer = () => {
  return (
    <Box className="bg-TEXT1 flex flex-col items-center  gap-10 md:py-[80px] py-[30px]">
      <Box className="bg-TEXT1 text-[#fff] flex justify-evenly sm:flex-nowrap flex-wrap gap-[20px] items-start px-3 ">
      ...
      <Box>
        <Typography className="text-[#fff]">
          <CopyrightIcon /> Copyright Rimel 2022. All right reserved
        </Typography>
      </Box>
    </Box>
  );
